...
public class Dashboard extends JFrame {
    ...
    private JButton btnPatient, btnDoctor, btnBilling, btnAppointment;
    ...
    public Dashboard() {
        ...
        // 3. Book Appointment Button (අලුත් බටන් එක)
        ...
        // 4. Billing Management Button
        btnBilling = new JButton("Billing Management");
        btnBilling.setFont(buttonFont);
        btnBilling.setBackground(primaryColor); // මේක වෙනස් පාටක් දැම්මා කැපිලා පේන්න
